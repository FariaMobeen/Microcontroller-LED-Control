...
void InitUART2(void) 
{
	...
	//Set to Baud 4800 with 500kHz clk on PIC24F
 	...
 	TRISBbits.TRISB0=0; //set u2TX/rb0/pin4 as UART TX   this is output
	TRISBbits.TRISB1=1; //set u2RX/rb1/pin5 as UART rx      this is input
	LATBbits.LATB0=1;  //making output pin 4 high
 ...
 */
    ...
    //configure baud rate, want uart and microcontroller to be talking at same speed
...
//void Disp2Dec(uint16_t Dec_num)
//{
//    uint8_t rem1, rem2;  // Remainders in division by 10
//    uint16_t quot;
//    
//    rem1 = Dec_num % 10;
//    quot = Dec_num / 10;
//    rem2 = quot % 10;
//    
//    XmitUART2(rem2 + 0x30, 1); // Display the tens digit
//    XmitUART2(rem1 + 0x30, 1); // Display the ones digit
//    
//    return;
//}
